...
export default function ResultsScreen() {
  ...
  const { imageBase64, scanId } = route.params || {};
  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      ...
      <TouchableOpacity style={styles.newScanButton} onPress={() => navigation.replace('Camera')}>
...
const styles = StyleSheet.create({
  ...
  stepTextActive: { color: '#1B5E20', fontWeight: '600' },
  ...
  imagePreview: { height: 200, borderRadius: 16, overflow: 'hidden', marginBottom: 16 },
